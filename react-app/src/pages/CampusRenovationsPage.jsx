...
<section className="section on-paper">
  <div className="container">
    <div className="grid grid-4 plaque-grid">
      <div className="plaque"><h4>Administration Building</h4></div>
      <div className="plaque"><h4>GKF Performing Arts Center</h4></div>
      <div className="plaque"><h4>G.P. Bowser Memorial Gymnasium</h4></div>
      <div className="plaque"><h4>Men’s Residence Hall</h4></div>
      <div className="plaque"><h4>Women’s Residence Hall</h4></div>
      <div className="plaque"><h4>Round House</h4></div>
      <div className="plaque"><h4>Student Union Building</h4></div>
      <div className="plaque"><h4>Entrance & Circle</h4></div>
      <div className="plaque"><h4>Guest Housing</h4></div>
      <div className="plaque"><h4>Health & Wellness Center</h4></div>
      <div className="plaque"><h4>Library Roof</h4></div>
    </div>
  </div>
</section>
