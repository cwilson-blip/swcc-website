...
# ---------------------------------------------------------------- President
add("president.html", "Meet Our President", "Meet Dr. Ervin D. Seamster, Jr., President and CEO of Southwestern Christian College.", f'''
...
<section class="section on-paper">
  <div class="container two-col">
    <div class="prose">
      ...
      <p>More than 25 years ago, Dr. Ervin D. Seamster, Jr. arrived at Southwestern Christian College as a student with limited academic confidence and a GPA that needed work. The faculty and mentors who surrounded him offered encouragement, prayer, and financial support &mdash; and turned his academic career around to Dean&rsquo;s List standing.</p>
      ...
      <p>His leadership emphasizes personal transformation, institutional excellence, and Christian values &mdash; shaping students into leaders across ministry, business, education, and beyond.</p>
      ...
      <p>Dr. Seamster was recently honored with the &ldquo;Spirit of the King&rdquo; Award from the City of Terrell, recognizing his leadership and dedication to the community.</p>
    </div>
    <aside>
      <div class="side-card">
        <h4>Past Letters From Our President</h4>
        <p style="color:var(--stone); font-size:0.92rem;">An archive of dated letters from Dr. Seamster spans March 2020 through March 2025, sharing updates and reflections with the SwCC community.</p>
      </div>
    </aside>
  </div>
</section>
