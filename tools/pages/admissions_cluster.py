...
# ---------------------------------------------------------------- How To Enroll
add("how-to-enroll.html", "How To Enroll", "Step-by-step instructions to enroll at Southwestern Christian College, including due dates, required forms, and fees.", f'''
...
<section class="section on-paper">
  <div class="container two-col">
    <div class="prose">
      ...
      <ul class="doc-list">
        <li><a href="https://www.swcc.edu/_files/ugd/0775cf_ecf226ff444146489895e96ee545f949.pdf" target="_blank" rel="noopener">General Application <span class="tag">PDF</span></a></li>
      ...
      <h2>Step 3 &mdash; Other Documents</h2>
      <ul>
        ...
        <li>A 600-word typed essay &mdash; <a href="http://swcc.edu/2017Required_Essay_Question.pdf" target="_blank" rel="noopener">view the required essay question</a></li>
        <li>Financial assistance: complete the <a href="{FAFSA_URL}" target="_blank" rel="noopener">FAFSA</a> using SwCC&rsquo;s school code <strong>003618</strong></li>
      </ul>

      <h2>Step 4 &mdash; Application Fee &amp; Dorm Deposit</h2>
      <div class="def-grid">
  ...
  <div class="container two-col">
    <div class="prose">
      ...
      <ul>
        ...
        <li>&ldquo;In&rdquo; Form and Transfer-Out Form</li>
